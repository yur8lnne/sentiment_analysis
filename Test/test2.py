...
train_data=pd.read_csv(r"C:\Users\조유라\Desktop\Test\data set\twitter_training.csv",names=["id","company","kind","tweet"])
train_data.head()
test_data=pd.read_csv(r"C:\Users\조유라\Desktop\Test\data set\twitter_validation.csv",names=["id","company","kind","tweet"])
test_data.head()
